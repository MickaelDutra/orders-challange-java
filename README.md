Este foi um desafio atribuído a mim para resolver o seguinte problema:
...
Obs: o id do pedido deve ser salvo no padrao UUID.
...
## Endpoints
1. /pedido
2. pedido/atualizar-status-pedido
3. pedido/atualizar-item-pedido/{id}
